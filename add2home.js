...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			en_us: 'xWonBet %device  uygulamasını indirmek için %icon simgesine dokunarak <strong>Ana Ekrana Ekle</strong>.',
			...
			tr_tr: '%device  uygulamasını indirmek için %icon simgesine dokunarak <strong>Ana Ekrana Ekle</strong>.',
